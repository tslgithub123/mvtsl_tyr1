...
const Add = () => {
    ...
    const fetchFormData = async (ulbCode) => {
        try {
            ...
            const response = await axios.get(`/api/v1/urbanview/${ulbCode}`, {
                headers: {
                ...
                <thead>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>{formData.second_form_question_628}</td>
                            <td></td>
                            <td></td>
                            <td></td>
                            <td></td>
                            ...
                            <td></td>
                            <td></td>
                            <td>{formData.second_form_question_629}</td>
