...
const OneUsers = () => {
    ...
    const exportToExcel = () => {
        ...
        XLSX.writeFile(wb, "1.5k-2.5k_Population_Cumulative.xlsx");
    };
    ...
    const fetchData = async (page) => {
        try {
            ...
            let endpoint;
            if (isAdmin) {
                endpoint = 'http://89.116.20.162:8080/api/v1/cities/rural/category/1.5k-2.5k';
            } else {
    ...
    return (
        <Layout>
            <div className='addUsertt'>
                <h1 className="text-center m-2">Cumulative of 1.5K-2.5K Population</h1>
