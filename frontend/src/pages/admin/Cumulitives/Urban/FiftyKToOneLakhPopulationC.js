...
const OneUsers = () => {
    ...
    const exportToExcel = () => {
        ...
        const ws = XLSX.utils.aoa_to_sheet([
            ...
            ["(Relative Marking)", "3.1", "Number of waterbodies rejuvenated by removing silt or through repair work during Majhi Vasundhara Abhiyan 4.0", "100", ...oneUsers.map(user => user.second_form_question_504)],

            ["(Relative Marking)", "3.1", "Upkeep: Number of waterbodies rejuvenated during Majhi Vasundhara Abhiyan 1.0, 2.0, 3.0 and maintained ", "50", ...oneUsers.map(user => user.second_form_question_512)],


            ["(Relative Marking)", "3.1", "Water storage capacity added through rejuvenation of existing waterbodies (in Cubic meter) during Majhi Vasundhara Abhiyan 4.0", "50", ...oneUsers.map(user => user.second_form_question_516)],
            ["", "3.2.1", "% of govt. buildings with water audit conducted during Majhi Vasundhara Abhiyan 3.0 and/or Majhi Vasundhara Abhiyan 4.0", "", ...oneUsers.map(user => user.second_form_question_520)],
    ...
    const fetchData = async (page) => {
        try {
            ...
            let endpoint;
            if (isAdmin) {
                endpoint = '/api/v1/cities/urban/category/50k-1lakh';
            } else {
    ...
    return (
        <Layout>
            <div className='addUsertt'>
                <h1 className="text-center m-2">Cumulative of 50K-1 Lakh Population</h1>
                                    ...
                                    <table className="custom-table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>50</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question512-${user.ulb_code}`}>{user.second_form_question_512}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td>(Relative Marking)</td>
                                                ...
                                                <td>50</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question516-${user.ulb_code}`}>{user.second_form_question_516}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td></td>
                                                ...
                                                <td></td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question520-${user.ulb_code}`}>{user.second_form_question_520}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td>(Relative Marking)</td>
                                                ...
                                                <td>50</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question525-${user.ulb_code}`}>{user.second_form_question_525}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td></td>
                                            ...
                                            <tr>
                                                ...
                                                <td>25</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question537-${user.ulb_code}`}>{user.second_form_question_537}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td></td>
                                                ...
                                                <td></td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question543-${user.ulb_code}`}>{user.second_form_question_543}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td>(Relative Marking)</td>
                                                ...
                                                <td>50</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question549-${user.ulb_code}`}>{user.second_form_question_549}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td>(Relative Marking)</td>
                                                ...
                                                <td>25</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question553-${user.ulb_code}`}>{user.second_form_question_553}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td>(Relative Marking)</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>20</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question569-${user.ulb_code}`}>{user.second_form_question_569}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td></td>
                                                ...
                                                <td>40</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question574-${user.ulb_code}`}>{user.second_form_question_574}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td></td>
                                                ...
                                                <td>25</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question583-${user.ulb_code}`}>{user.second_form_question_583}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td></td>
                                                ...
                                                <td>50</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question587-${user.ulb_code}`}>{user.second_form_question_587}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td></td>
                                                ...
                                                <td>30</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question591-${user.ulb_code}`}>{user.second_form_question_591}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td></td>
                                                ...
                                                <td>50</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question595-${user.ulb_code}`}>{user.second_form_question_595}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td></td>
                                                ...
                                                <td></td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question599-${user.ulb_code}`}>{user.second_form_question_599}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td></td>
                                                ...
                                                <td>50</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question605-${user.ulb_code}`}>{user.second_form_question_605}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td>(Relative Marking)</td>
                                                ...
                                                <td>20</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question609-${user.ulb_code}`}>{user.second_form_question_609}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td>(Relative Marking)</td>
                                                ...
                                                <td>50</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question615-${user.ulb_code}`}>{user.second_form_question_615}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td></td>
                                                ...
                                                <td>30</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question621-${user.ulb_code}`}>{user.second_form_question_621}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td>(Relative Marking)</td>
                                                ...
                                                <td>50</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question625-${user.ulb_code}`}>{user.second_form_question_625}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td>(Relative Marking)</td>
                                                ...
                                                <td>50</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question631-${user.ulb_code}`}>{user.second_form_question_631}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td>(Relative Marking)</td>
                                                ...
                                                <td>50</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question637-${user.ulb_code}`}>{user.second_form_question_637}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td></td>
                                                ...
                                                <td>100</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question643-${user.ulb_code}`}>{user.second_form_question_643}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td></td>
                                            ...
                                            <tr>
                                                ...
                                                <td>100</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question655-${user.ulb_code}`}>{user.second_form_question_655}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td></td>
                                                ...
                                                <td>100</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question662-${user.ulb_code}`}>{user.second_form_question_662}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td>(Relative Marking)</td>
                                                ...
                                                <td>200</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question672-${user.ulb_code}`}>{user.second_form_question_672}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td>(Relative Marking)</td>
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question682-${user.ulb_code}`}>{user.second_form_question_682}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td></td>
                                                ...
                                                <td></td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question687-${user.ulb_code}`}>{user.second_form_question_687}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td></td>
                                                ...
                                                <td></td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question692-${user.ulb_code}`}>{user.second_form_question_692}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td>(Relative Marking)</td>
                                                ...
                                                <td>100</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question697-${user.ulb_code}`}>{user.second_form_question_697}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td>(Relative Marking)</td>
                                                ...
                                                <td>40</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question705-${user.ulb_code}`}>{user.second_form_question_705}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td>(Relative Marking)</td>
                                                ...
                                                <td>40</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question711-${user.ulb_code}`}>{user.second_form_question_711}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td>(Relative Marking)</td>
                                                ...
                                                <td>20</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question717-${user.ulb_code}`}>{user.second_form_question_717}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td></td>
                                                ...
                                                <td></td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question723-${user.ulb_code}`}>{user.second_form_question_723}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td>(Relative Marking)</td>
                                                ...
                                                <td>50</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question731-${user.ulb_code}`}>{user.second_form_question_731}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td>(Relative Marking)</td>
                                                ...
                                                <td>200</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question739-${user.ulb_code}`}>{user.second_form_question_739}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td>(Relative Marking)</td>
                                                ...
                                                <td>100</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question744-${user.ulb_code}`}>{user.second_form_question_744}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td>(Relative Marking)</td>
                                                ...
                                                <td>75</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question749-${user.ulb_code}`}>{user.second_form_question_749}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td>(Relative Marking)</td>
                                                ...
                                                <td>25</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question753-${user.ulb_code}`}>{user.second_form_question_753}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td>(Relative Marking)</td>
                                                ...
                                                <td>100</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question757-${user.ulb_code}`}>{user.second_form_question_757}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td></td>
                                            ...
                                            <tr>
                                                ...
                                                <td>100</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question761-${user.ulb_code}`}>{user.second_form_question_761}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td>(Relative Marking)</td>
                                                ...
                                                <td>100</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question767-${user.ulb_code}`}>{user.second_form_question_767}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td>(Relative Marking)</td>
                                                ...
                                                <td>200</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question773-${user.ulb_code}`}>{user.second_form_question_773}</td>
                                                ))}
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>50</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question780-${user.ulb_code}`}>{user.second_form_question_780}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td>(Relative Marking)</td>
                                                ...
                                                <td>50</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question786-${user.ulb_code}`}>{user.second_form_question_786}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td>(Relative Marking)</td>
                                                ...
                                                <td>100</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question792-${user.ulb_code}`}>{user.second_form_question_792}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td>(Relative Marking)</td>
                                                ...
                                                <td>50</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question798-${user.ulb_code}`}>{user.second_form_question_798}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td>(Relative Marking)</td>
                                                ...
                                                <td>50</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question804-${user.ulb_code}`}>{user.second_form_question_804}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td>(Relative Marking)</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>50</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question810-${user.ulb_code}`}>{user.second_form_question_810}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td>(Relative Marking)</td>
                                                ...
                                                <td>50</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question817-${user.ulb_code}`}>{user.second_form_question_817}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td>(Relative Marking)</td>
                                                ...
                                                <td>30</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question824-${user.ulb_code}`}>{user.second_form_question_824}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td>(Relative Marking)</td>
                                                ...
                                                <td>20</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question830-${user.ulb_code}`}>{user.second_form_question_830}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td>(Relative Marking)</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>500</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question848-${user.ulb_code}`}>{user.second_form_question_848}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td></td>
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question856-${user.ulb_code}`}>{user.second_form_question_856}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td></td>
                                                ...
                                                <td></td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question863-${user.ulb_code}`}>{user.second_form_question_863}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td></td>
                                                ...
                                                <td></td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question870-${user.ulb_code}`}>{user.second_form_question_870}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td>(Relative Marking)</td>
                                                ...
                                                <td>50</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question877-${user.ulb_code}`}>{user.second_form_question_877}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td>(Relative Marking)</td>
                                                ...
                                                <td>100</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-question882-${user.ulb_code}`}>{user.second_form_question_882}</td>
                                                ))}
                                            </tr>
                                            <tr>
                                                <td>(Relative Marking)</td>
                                                ...
                                                <td>100</td>
                                                {oneUsers.map((user) => (
                                                    <td key={`city-second_form_question889-${user.ulb_code}`}>{user.second_form_question_889}</td>
                                                ))}
                                            </tr>
